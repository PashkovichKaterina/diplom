...
import by.bsu.pashkovich.converter.TopicConverter;
...
public class TopicController {
    ...
    @GetMapping
    public ResponseEntity getTopicsByCourseNumber(Long course, PageRequest pageRequest) {
        List<TopicDto> topics;
        if (pageRequest.getPage() == null) {
            topics = topicConverter.toTopicDtoList(topicService.getTopicsByCourse(course));
